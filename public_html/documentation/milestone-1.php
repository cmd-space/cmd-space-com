...
<html lang="en">
	<head>
		...
		<title>cmd-space milestone 1</title>
		...
		<div class="site-wrapper">
			...
			<div class="site-wrapper-inner">
				...
				<div class="cover-container">
					...
					<h1>Milestone 1</h1>
					<h2>if (Purpose && Audience && Goal) {</h2>
					<h3>Purpose:</h3>
					<p>My single page personal website will be used to show off my skill and talent as a web developer, and will eventually turn into a wide range of portfolio items</p>
					<h3>Audience:</h3>
					<p>My audience will mainly consist of potential freelance clients and potential employers and/or hiring managers</p>
					<h3>Goal:</h3>
					<p>To acquire an internship, a full-time position and to attract freelance clients</p>
					<h2>}</h2>
